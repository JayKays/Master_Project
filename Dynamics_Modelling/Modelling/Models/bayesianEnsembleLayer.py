...
class BayesianLinearEnsembleLayer(BayesianModule):
    ...
    This can also be used as an efficient layer for a bayesian network ensemble, this is done by having num_members > 1
    ...
    def forward(self, x):
        ...
        #Calculate forward pass output whith sampled weights/bias
        xw = x.matmul(w) + b
    ...
    def forward_frozen(self, x):
        ...
        Equivalent to linear deterministic forward pass
        """
        if self.bias:
